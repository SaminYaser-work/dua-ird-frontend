        ...
        <div className="row-span-full hidden xl:block xl:z-[-1] 2xl:block 2xl:z-[-1] 3xl:block 3xl:z-[-16]">
            ...
            >
                <div className="bg-white rounded-3xl px-4 dark:bg-dark-bg lg:h-[calc(93vh)] xl:h-[94vh] 2xl:h-[93vh] 3xl:h-[93vh] scrl-left pb-16">
                    ...
                    <div
                        className="justify-center items-center  cursor-pointer my-2 flex flex-row w-full rounded-lg group"
                        style={{ transform: "none" }}
                    >
                        <div className=" w-1 rounded-tl-lg rounded-bl-lg "></div>
                        <div className="p-2 flex flex-row justify-center items-center">
                            <div className="bg-slate-200 flex p-2 rounded-full items-center h-10 w-10 justify-center">
                                <img
                    ...
                    >
                        <div className=" w-1 rounded-tl-lg rounded-bl-lg "></div>
                        <div className="p-2 flex flex-row justify-center items-center">
                            <div className=" bg-slate-200 dark:bg-dark-bg-dark flex p-2 rounded-full items-center h-10 w-10 justify-center">
                                <img
                    ...
                    <div>
                        <div className="pt-6 xl:pt-16 2xl:pt-16 3xl:pt-24 pb-2 text-center">
                            <button className="w-14 h-14 bg-green-500 drop-shadow-primary rounded-lg text-white">
